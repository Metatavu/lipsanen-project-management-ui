...
function RolesIndexRoute() {
     ...
     */
    const renderMdiIconifyIconWithBackground = (iconName?: string, backgroundColor?: string) => {
        if (!iconName || !backgroundColor) {
            return null;
        }

        return (
            <div style={{ width: 30, height: 30, borderRadius: "50%", backgroundColor: backgroundColor, alignItems: "center", justifyContent: "center", display: "flex" }}>
