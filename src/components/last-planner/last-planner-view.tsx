...
const UserRows = ({
  ...
  const filledTableRows = tasksGroupedToRows.map(
    renderTaskRows(timelineInterval, editMode, onTaskClick, onSwitchTaskStatus, {
      enableDrag: !!dragMode,
 ...
 */
const LastPlannerView = ({ projectId, editMode, setEditMode, dragMode, setDragMode }: Props) => {
